...
function parseParameters(options) {
    var opt = {
        ...
        timeout: Infinity,
               locationStatus:"为便于您的贷款申请，请打开GPS定位和相机权限",
               authorStatus:"为便于您的贷款申请，请打开GPS定位和相机权限"
    };
   ...
   */
    getCurrentPosition:function(successCallback, errorCallback, options) {
        ...
        // Otherwise we have to call into native to retrieve a position.
            ...
            exec(win, fail, "QHGeoLocationPlugin", "getLocation", [options.enableHighAccuracy, options.maximumAge, options.locationStatus, options.authorStatus]);
        }
        return timeoutTimer;
    },
    /**
