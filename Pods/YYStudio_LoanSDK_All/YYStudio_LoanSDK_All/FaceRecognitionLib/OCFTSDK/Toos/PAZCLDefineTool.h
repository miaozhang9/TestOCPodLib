...
//[UIColor colorWithRed:93/255. green:88/255. blue:88/255. alpha:1.]
...
#define kScaleWidth6(width)      ((width)*kScreenWidth)/375     //宽度按比例适配
#define kScaleHeight6(height)    ((height)*kScreenHeight)/667   //高度按比例适配
