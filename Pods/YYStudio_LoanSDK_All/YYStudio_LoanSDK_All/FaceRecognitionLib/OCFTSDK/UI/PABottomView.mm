...
//
//    [self addConstraint:[NSLayoutConstraint constraintWithItem:imageA attribute:NSLayoutAttributeWidth relatedBy:NSLayoutRelationEqual toItem:self.imageViewA attribute:NSLayoutAttributeHeight multiplier:.6 constant:0]];
//    [self addConstraint:[NSLayoutConstraint constraintWithItem:imageA attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem:self.imageViewA attribute:NSLayoutAttributeHeight multiplier:.6 constant:0]];
//
...
//
    ...
    [self addConstraint:[NSLayoutConstraint constraintWithItem:messageLabelA attribute:NSLayoutAttributeCenterX relatedBy:NSLayoutRelationEqual toItem:self.imageViewA attribute:NSLayoutAttributeCenterX multiplier:1 constant:0]];
    [self addConstraint:[NSLayoutConstraint constraintWithItem:messageLabelA attribute:NSLayoutAttributeCenterY relatedBy:NSLayoutRelationEqual toItem:self.imageViewA attribute:NSLayoutAttributeCenterY multiplier:1 constant:0]];
    
    [self addConstraint:[NSLayoutConstraint constraintWithItem:messageLabelB attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem:self.imageViewB attribute:NSLayoutAttributeHeight multiplier:1 constant:0]];
    [self addConstraint:[NSLayoutConstraint constraintWithItem:messageLabelB attribute:NSLayoutAttributeWidth relatedBy:NSLayoutRelationEqual toItem:self.imageViewB attribute:NSLayoutAttributeWidth multiplier:1 constant:0]];
...
- (void)showPromtpView{
    ...
    if (!imageBackGround){
        ...
        [self addConstraint:[NSLayoutConstraint constraintWithItem:imageBackGround attribute:NSLayoutAttributeBottom relatedBy:NSLayoutRelationEqual toItem:self attribute:NSLayoutAttributeBottom multiplier:0.75 constant:0]];
